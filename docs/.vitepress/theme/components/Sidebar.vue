...
<template>
  <aside class="sidebar">
    ...
    <div class="profile">
      ...
      <p class="bio">记录学习、实践和个人成长历程</p>
      <div class="social-links">
        <a href="https://github.com/LoveTamako" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="GitHub">
        ...
        <a href="mailto:paprika.wang@gmail.com" class="social-link" aria-label="Email">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
